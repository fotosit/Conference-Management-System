...
CREATE TABLE `Users` (
  ...
  `universityName` varchar(45) COLLATE utf8_turkish_ci NOT NULL,
  `userName` varchar(20) COLLATE utf8_turkish_ci NOT NULL,
  `userPassword` varchar(20) COLLATE utf8_turkish_ci NOT NULL,
  `role` int NOT NULL,
  `refereeInterests` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  PRIMARY KEY (`userId`),
...
INSERT INTO `Users` VALUES (1,'Admin','Admin','admin@test.com','Ege University','admin','admin',4,NULL);
